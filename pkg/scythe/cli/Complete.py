...
# declaration
class Complete(scythe.shells.command, family="scythe.cli.complete"):
    """
    Assist with shell auto-completion
    """

    word = scythe.properties.str()
    word.doc = "the word we are attempting to auto-complete"

    line = scythe.properties.str()
    line.doc = "the partial command line"


    # administrative
    @scythe.export(tip="generate completions candidates from a partial command line")
